...
public function register(Request $request){
   ...
   $validated = $request->validate([
        ...
        'nationalities'  => 'nullable|string|max:100',
    ]);
  ...
  $user = User::where('email', $request->email)->first();
    ...
    return response()->json([
        ...
        'response' => [
            ...
            'nationality'        => $user->nationalities ?? null,
            'phone' => $user->phone ? (int) $user->phone : null,
...
public function resendotp(Request $request)
{
        ...
        EmailOtp::updateOrCreate(
            ['user_id' => $user->id, 'type' => $request->type], // use correct type
  ...
  public function update(Request $request)
{
    ...
    // Store in public_html/uploads/profile_images
    $image->move(public_path('../../uploads/profile_images'), $filename);

    $user->photo = 'uploads/profile_images/' . $filename;
}
    ...
    return response()->json([
        ...
        'response' => [
            ...
            'phone'         => $user->phone,
        //    'photo' => $user->photo ? asset('core/storage/app/public/' . $user->photo) : null
        'photo' => $user->photo ? asset($user->photo) : null
   ...
   public function resetPassword(Request $request)
{
    ...
    $emailOtp = EmailOtp::where('user_id', $user->id)
        ->where('type', 2) // type 2 = password reset
