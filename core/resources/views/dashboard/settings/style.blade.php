<div class="tab-pane {{ Session::get('active_tab') == 'styleTab' || Session::get('active_tab') == '' ? 'active' : '' }}"
    id="tab-5">
    <div class="p-a-md">
    ...
    <div class="p-a-md col-md-12">
        ...
        <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                            <div id="cp3" class="input-group colorpicker-component">
                                {!! Form::text('style_color3', $Setting->style_color3, [
                                    'placeholder' => '',
                                    'class' => 'form-control',
                                    'id' => 'style_color3',
                                    'dir' => 'ltr',
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                            <div id="cp4" class="input-group colorpicker-component">
                                {!! Form::text('style_color4', $Setting->style_color4, [
                                    'placeholder' => '',
                                    'class' => 'form-control',
                                    'id' => 'style_color4',
                                    'dir' => 'ltr',
            ...
            <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php
                        $themes = [['#0cbaa4', '#EF7E35', '#edf3f2', '#dfeae8'], ['#84ba3f', '#45631d', '#f2f3ed', '#e8eadf'], ['#00b106', '#14700c', '#edf3ed', '#dfeae0'], ['#1977cc', '#054a8a', '#f1f7fd', '#d5dbe0'], ['#1c46ff', '#101e52', '#f1f4fd', '#d5d7e0'], ['#6a10fd', '#351073', '#efedf3', '#e4dfea'], ['#ff796c', '#5f221d', '#f3eeed', '#eae2df'], ['#f41e54', '#481a2a', '#f3edef', '#eadfe4'], ['#d12326', '#222222', '#f3eded', '#eadfdf'], ['#ba893f', '#664412', '#f3f0ed', '#eae4df'], ['#f57703', '#000000', '#f3f0ed', '#eae5df'], ['#f7c605', '#3b3b3a', '#f3f2ed', '#eae8df']];
                        ?>
        ...
        <div class="row m-t">
            ...
            <div class="col-sm-6">
                ...
                <div class="radio">
                    <label class="md-check">
                        {!! Form::radio('style_change', '1', $Setting->style_change ? true : false, [
                            'id' => 'style_change0',
                            'class' => 'has-value',
                        ]) !!}
                        <i class="primary"></i>
                    ...
                    &nbsp; &nbsp;
                    <label class="md-check">
                        {!! Form::radio('style_change', '0', $Setting->style_change ? false : true, [
                            'id' => 'style_header1',
                            'class' => 'has-value',
                        ]) !!}
                        <i class="danger"></i>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-6  {{ $Setting->style_header ? '' : 'displayNone' }}" id="transparentHeaderDiv">
                    ...
                    <div class="radio">
                        <label class="md-check">
                            {!! Form::radio('style_bg_type', '1', $Setting->style_bg_type ? true : false, [
                                'id' => 'style_bg_type1',
                                'class' => 'has-value',
                            ]) !!}
                            <i class="primary"></i>
                        ...
                        &nbsp; &nbsp;
                        <label class="md-check">
                            {!! Form::radio('style_bg_type', '0', $Setting->style_bg_type ? false : true, [
                                'id' => 'style_bg_type2',
                                'class' => 'has-value',
                            ]) !!}
                            <i class="danger"></i>
