			...
			<div class="container">
				<div class="row">
					<div class="col-xxl-12 col-lg-12">
						<div
							class="post-19 post type-post status-publish format-standard has-post-thumbnail hentry category-live-game tag-e-sports tag-tournaments th-blog blog-single has-post-thumbnail">
							<!-- Post Thumbnail -->
							<div class="blog-img"><img fetchpriority="high" width="750" height="360"
									...
									sizes="(max-width: 750px) 100vw, 750px" /></div><!-- End Post Thumbnail -->
							<div class="blog-content">
								<div class="blog-meta">
									<a href="#"><i class="far fa-user"></i>By Admin</a>
									<a href="#"><i class="far fa-calendar"></i><?PHP echo date('d M, Y', strtotime($Topic->date)); ?></a>
								</div>
								<p class="blog-text">{!! $Topic->$details_var !!} </p>
							</div>
						</div>
					</div>
				</div>
