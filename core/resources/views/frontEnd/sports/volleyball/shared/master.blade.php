...
<head>
    <!-- ======= Meta & CSS ======= -->
    @stack('before-styles')
    @include('frontEnd.sports.cricket.shared.head')
</head>
...
<body>
	...
	<div id="main-wrapper" class="main-wrapper overflow-hidden">
		<!-- ======= Header ======= -->
		@include('frontEnd.sports.cricket.shared.header')
		
		@yield('content')
		
		<!-- ======= Footer ======= -->
		@include('frontEnd.sports.cricket.shared.footer')

	</div>

<!-- ======= JS Including ======= -->
@stack('before-scripts')
@include('frontEnd.sports.cricket.shared.foot')
</body>
</html>
