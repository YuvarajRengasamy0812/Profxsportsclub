@extends('frontEnd.sports.cricket.shared.master')
	...
	<div class="hero-banner-1">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="content">
						<h1 class="mb-12 light-black">Where Every
							Innings is an Adventure</h1>
						<p class="mb-32 light-black">Lorem ipsum dolor
							sit amet consectetur. Suspendisse dictumst
							amet in varius urna. Arcu eget in adipiscing
							ac ultricies malesuada.</p>
						<div class="btn-block">
							...
							<div class="overlay d-md-inline-block"
								data-bs-toggle="modal"
								data-bs-target="#videoModal">
								<a href="#" class="play-button fw-600
									fs-25"
