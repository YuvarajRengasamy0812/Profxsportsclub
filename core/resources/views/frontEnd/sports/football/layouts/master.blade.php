...
<head>
    <meta charset="utf-8">
	<title>Football | {{(@$PageTitle !="")? @$PageTitle:Helper::GeneralSiteSettings("site_title_" . @Helper::currentLanguage()->code)}}</title>
	...
	<link rel="stylesheet" href="{{ URL::asset('assets/frontend/sports/common/flaticon/football/flaticon.css') }}?v={{ Helper::system_version() }}">
	<link rel="stylesheet" href="{{ URL::asset('assets/frontend/sports/football/css/football_style.css') }}?v={{ Helper::system_version() }}">
...
<body>
	<div id="preloader">
        <div id="status">
            <img src="{{ URL::asset('assets/frontend/sports/football/images/loader.gif') }}" id="preloader_image" alt="loader">
        </div>
    </div>
	...
	<!-- ======= Header ======= -->
	@include('frontEnd.sports.football.layouts.header')
	
	@yield('content')
	
	<!-- ======= Footer ======= -->
	@include('frontEnd.sports.football.layouts.footer')
...
<script src="{{ URL::asset('assets/frontend/sports/football/js/cursor.js') }}?v={{ Helper::system_version() }}"></script>
<script src="{{ URL::asset('assets/frontend/sports/football/js/football.js') }}?v={{ Helper::system_version() }}"></script>
