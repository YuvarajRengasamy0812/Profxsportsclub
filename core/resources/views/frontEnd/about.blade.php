...
@section('content')
    <div class="home-page">
        ...
        @include('frontEnd.aboutpage.bannar')
        @include('frontEnd.aboutpage.mission')
		@include('frontEnd.aboutpage.eligibility')
        @include('frontEnd.aboutpage.conduct')
        @include('frontEnd.aboutpage.rule')
		<!-- @include('frontEnd.aboutpage.organizing') -->
