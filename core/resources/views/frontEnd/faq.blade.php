...
<style>
    ...
    <div>
        ...
        @endif
        <section class="breadcumb-wrapper" data-bg-src="{{ URL::asset('assets/frontend/img/breadcumb-bg.png') }}">
            <div class="container">
                <div class="breadcumb-content">
                    <h1 class="breadcumb-title pt-5">{{ $page_title }}</h1>
                        ...
                        <div class="row">
                            ...
                            @if ($cats_count)
                                @foreach ($Categories as $Category)
                                    ...
                                    ?>
                                    <div class="col-12">
                                        <h3 class="accordion-cat-title mb-3 text-white">
                                            @if ($Category->icon != '')
                                                <i class="fa {{ $Category->icon }}"></i> &nbsp;
                                            @endif
                                            {{ $Category_title }}
                                        </h3>
                                        <div id="accordion-{{ $Category->id }}" class="mb-5 accordion faq-wrap2">
                                            ...
                                            @if ($Topics->count() > 0)
                                                @foreach ($Topics as $Topic)
                                                    <div class="accordion-card style2">
                                                        @include('frontEnd.topic.accordion', [
                                                            'Topic' => $Topic,
                                                            'CatId' => $Category->id,
                                                        ])
                                                    </div>
                            ...
                            @else
                                ...
                                @if ($Topics->count() > 0)
                                    @foreach ($Topics as $Topic)
                                        ...
                                        $i++;
                                        ?>
                                        <div class="col-12 accordion faq-wrap2">
                                            @include('frontEnd.topic.accordion', [
                                                'Topic' => $Topic,
                                                'CatId' => 0,
                                            ])
