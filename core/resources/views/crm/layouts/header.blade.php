...
<header class="bg-white/80 backdrop-blur-md border-b border-slate-100 sticky top-0 z-50 px-4 sm:px-6 md:px-8 lg:px-12 py-4 flex justify-between items-center">
    ...
    <div class="flex items-center gap-2 sm:gap-3">
        ...
        <!-- Social Links -->
        <a href="https://www.facebook.com/profxsportsclub" target="_blank" class="p-2 sm:p-3 bg-white text-[#e85a3c] rounded-2xl border border-slate-100 hover:text-[#0f172a] hover:bg-slate-50 transition flex items-center justify-center">
        ...
        <a href="https://www.instagram.com/profxsportsclub" target="_blank" class="p-2 sm:p-3 bg-white text-[#e85a3c] rounded-2xl border border-slate-100 hover:text-[#0f172a] hover:bg-slate-50 transition flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://www.linkedin.com/company/profxsportsclub" target="_blank" class="p-2 sm:p-3 bg-white text-[#e85a3c] rounded-2xl border border-slate-100 hover:text-[#0f172a] hover:bg-slate-50 transition flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="relative bg-white w-full max-w-md rounded-[3rem] p-6 sm:p-10 shadow-2xl">
        ...
        <div class="space-y-6 sm:space-y-8">
            ...
            <div class="p-4 sm:p-6 bg-slate-50 rounded-[2rem] border border-slate-100 text-center">
                <img src="{{ $user->photo ? asset($user->photo) : asset('assets/frontend/images/user.png') }}" onerror="this.src='{{ asset('assets/frontend/images/user.png') }}'" class="w-16 h-16 sm:w-20 sm:h-20 rounded-full mx-auto mb-2 sm:mb-4 border-4 border-white object-cover shadow-lg">
