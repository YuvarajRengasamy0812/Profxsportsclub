...
/*Custom APIs*/
Route::post('/register', 'APIsController@register')->name('register');
Route::post('/verify', 'APIsController@verify')->name('verify');
Route::post('/resendotp', 'APIsController@resendotp')->name('resendotp');
Route::post('/login',  'APIsController@login')->name('login');
// Route::post('/logout',  'APIsController@logout')->name('logout');
Route::get('/profile',  'APIsController@profile')->name('profile');
Route::post('/update',  'APIsController@update')->name('update');
Route::post('/forgetpassword',  'APIsController@forgetpassword')->name('forgetpassword');
Route::post('/resetpassword',  'APIsController@resetPasswordWithOtp')->name('resetpassword');
Route::get('/countries',  'APIsController@countries')->name('countries');
